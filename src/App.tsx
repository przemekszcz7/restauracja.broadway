...
export default function App() {
  ...
  return (
    <div className="min-h-screen font-sans selection:bg-gold selection:text-black">
      {/* Navigation */}
      <nav className="fixed top-0 z-50 w-full bg-obsidian/80 backdrop-blur-2xl transition-all duration-700 hover:bg-obsidian/95 border-b border-gold/5">
        ...
        <div className="mx-auto flex max-w-7xl items-center justify-between px-10 py-8">
          <motion.div 
            ...
            className="font-serif text-3xl font-light italic text-gold cursor-pointer uppercase tracking-[0.5em] transition-all hover:text-gold-light"
          >
            Broadway
          </motion.div>
      ...
      <section className="relative flex h-screen items-center justify-center overflow-hidden bg-black selection:bg-velvet selection:text-white">
        ...
        <div className="absolute inset-0 z-10 pointer-events-none overflow-hidden">
          <motion.div 
            ...
            className="absolute -top-1/4 left-1/4 h-[150%] w-[150%] bg-[radial-gradient(circle_at_center,rgba(212,175,55,0.05)_0%,transparent_60%)] blur-[120px]"
          />
        ...
        <div className="relative z-20 text-center px-4 max-w-5xl mx-auto">
          ...
          >
            ...
            <motion.p variants={itemVariants} className="mt-12 font-serif text-2xl sm:text-4xl text-white/80 max-w-3xl mx-auto italic tracking-wider leading-relaxed">
      ...
      {/* About Section */}
      <section id="o-nas" className="relative py-64 px-8 overflow-hidden bg-obsidian">
        ...
        <div className="mx-auto max-w-7xl relative z-10">
          <div className="grid gap-40 lg:grid-cols-2 lg:items-center">
            <motion.div
              ...
              className="relative"
            >
              <div className="absolute -left-20 -top-20 text-[25vw] font-serif italic text-white/[0.02] pointer-events-none select-none -z-10">Scene</div>
              
              <motion.h2 variants={itemVariants} className="theater-heading text-6xl sm:text-8xl mb-16 relative z-10 border-l-4 border-velvet/20 pl-8">Nasza Kuchnia</motion.h2>
              
              <div className="space-y-12 text-2xl text-white/70 leading-relaxed font-sans relative z-10">
                <motion.p variants={itemVariants} className="first-letter:text-7xl first-letter:font-serif first-letter:text-gold first-letter:mr-4 first-letter:float-left first-letter:leading-[0.8] first-letter:mt-2">
                ...
                <motion.div variants={itemVariants} className="pt-20 mt-20 group relative">
                  <div className="absolute top-0 left-0 w-24 h-[2px] bg-gold/30"></div>
                  <span className="font-display text-[10px] uppercase tracking-[0.5em] text-gold/40 mb-8 block font-semibold transition-all group-hover:text-gold group-hover:tracking-[0.6em]">Premiera Smaku</span>
                  <p className="text-3xl italic font-serif text-white/95 leading-tight transition-all duration-700 group-hover:text-gold-light group-hover:translate-x-2">
            ...
            >
              <div className="absolute -inset-8 border border-gold/10 transition-all duration-1000 group-hover:scale-105 group-hover:border-gold/30"></div>
              <div className="aspect-[3/4] overflow-hidden relative rounded-sm shadow-[0_60px_100px_-20px_rgba(0,0,0,0.8)] border border-white/5">
                <img 
                  src={images[1]} 
              ...
              <div className="absolute -top-10 -left-10 w-20 h-20 border-t-2 border-l-2 border-gold/30 group-hover:border-gold group-hover:w-24 group-hover:h-24 transition-all duration-700"></div>
              <div className="absolute -bottom-10 -right-10 w-20 h-20 border-b-2 border-r-2 border-gold/30 group-hover:border-gold group-hover:w-24 group-hover:h-24 transition-all duration-700"></div>
            </motion.div>
          </div>
        </div>
      </section>
      ...
      <section id="godziny" className="bg-[#020202] py-64 px-8 border-y border-gold/10 relative">
          ...
          <div className="grid gap-40 lg:grid-cols-2">
            ...
            >
              <div className="flex flex-col items-center lg:items-start mb-24">
                <motion.h2 variants={itemVariants} className="theater-heading text-6xl sm:text-7xl mb-6">Zapraszamy</motion.h2>
              ...
              <div className="space-y-0 group/hours">
                {openingHours.map((item, idx) => (
                  <motion.div 
                    key={idx} 
                    variants={itemVariants}
                    className="flex justify-between py-8 border-b border-white/5 transition-all duration-500 hover:pl-8 hover:border-gold/40 group/item relative overflow-hidden"
                  >
                    ...
                    <span className="font-display text-[12px] uppercase tracking-[0.2em] text-white/30 group-hover/item:text-gold transition-colors font-medium">{item.day}</span>
                    <span className="font-serif italic text-2xl text-white/80 group-hover/item:text-white group-hover/item:tracking-wide transition-all">{item.hours}</span>
                  </motion.div>
                ))}
              </div>
              ...
              <motion.div 
                variants={itemVariants}
                className="mt-32 p-16 border border-gold/10 bg-white/[0.01] relative overflow-hidden group/quote shadow-2xl backdrop-blur-sm"
              >
                ...
                <p className="italic text-3xl text-white/95 mb-12 font-serif leading-relaxed relative z-10 transition-all group-hover:translate-x-2">
                ...
                <div className="h-px w-32 bg-gold/30 mb-10"></div>
                <motion.a 
                  whileHover={{ x: 15 }}
                  href="https://www.facebook.com/profile.php?id=61562929442326&sk=reviews" 
                  target="_blank" 
                  rel="noreferrer"
                  className="relative z-10 inline-flex items-center gap-6 text-[11px] uppercase tracking-[0.4em] text-gold font-display transition-all hover:text-gold-light hover:tracking-[0.5em]"
                >
            ...
            >
              <div className="flex flex-col items-center lg:items-start mb-24">
                <motion.h2 variants={itemVariants} className="theater-heading text-6xl sm:text-7xl mb-6">Gdzie Jesteśmy</motion.h2>
                <motion.div variants={itemVariants} className="h-1 w-24 bg-velvet/40"></motion.div>
              </div>

              <motion.div 
                variants={itemVariants}
                className="relative mb-24 aspect-video w-full overflow-hidden grayscale group hover:grayscale-0 transition-all duration-[1500ms] shadow-[0_80px_120px_-30px_rgba(0,0,0,1)] ring-1 ring-gold/30 group-hover:ring-gold/60"
              >
                <div className="absolute inset-0 pointer-events-none z-10 box-decoration-clone border-[20px] border-obsidian/60 transition-all group-hover:border-transparent"></div>
                <iframe 
              ...
              <div className="space-y-16">
                {[
                  ...
                  <motion.div key={idx} variants={itemVariants} className="flex items-start gap-10 group">
                    <div className="mt-2 p-4 rounded-full border border-gold/10 group-hover:border-gold/60 transition-all duration-700 bg-gold/[0.03] group-hover:bg-gold/10 shadow-[0_0_20px_rgba(212,175,55,0)] group-hover:shadow-[0_0_30px_rgba(212,175,55,0.2)]">
                      <item.icon className="text-gold" size={28} strokeWidth={1} />
                    </div>
                    <div>
                      <p className="font-display text-[10px] uppercase tracking-[0.5em] text-white/30 mb-4 block font-medium group-hover:text-gold transition-colors">{item.label}</p>
                      <p className="text-3xl font-serif italic text-white/95 group-hover:text-gold-light transition-all duration-700 group-hover:translate-x-2">{item.val}</p>
                    </div>
                  </motion.div>
                ))}
              </div>
      ...
      {/* Socials & Reels */}
      <section id="social" className="py-64 px-8 bg-obsidian relative">
        ...
        <div className="mx-auto max-w-7xl text-center">
          <motion.div
            ...
            className="mb-40"
          >
            <motion.h2 variants={itemVariants} className="theater-heading text-7xl sm:text-9xl mb-10 drop-shadow-2xl">Broadway na żywo</motion.h2>
            <motion.p variants={itemVariants} className="text-gold/50 font-display text-[11px] uppercase tracking-[0.8em] font-medium">Codzienne spektakle smaku na Twoim ekranie</motion.p>
            <motion.div variants={itemVariants} className="ornament-line opacity-40 mt-16"></motion.div>
          </motion.div>
          ...
          <motion.div 
            ...
            viewport={{ once: true }}
            variants={containerVariants}
            className="grid gap-24 sm:grid-cols-2 max-w-6xl mx-auto mb-48"
          >
            {reels.map((url, idx) => (
              <motion.div
                key={idx}
                ...
                className="group relative aspect-[9/16] w-full overflow-hidden border border-gold/20 bg-black shadow-[0_60px_100px_-30px_rgba(0,0,0,1)] ring-1 ring-white/5 active:scale-95 transition-all"
              >
                <iframe 
                  src={url} 
                  width="100%" 
          ...
          <motion.div 
            ...
            viewport={{ once: true }}
            variants={containerVariants}
            className="flex flex-wrap items-center justify-center gap-24 sm:gap-48"
          >
            {[
              ...
              >
                <div className="relative">
                  ...
                  <div className="relative flex h-28 w-28 items-center justify-center rounded-full border border-gold/10 transition-all duration-1000 group-hover:border-gold/80 group-hover:bg-gold/10 shadow-[0_0_40px_rgba(212,175,55,0)] group-hover:shadow-[0_0_60px_rgba(212,175,55,0.3)]">
                    <social.icon size={36} strokeWidth={1} className="text-white group-hover:text-gold transition-all duration-700 group-hover:scale-110" />
                  </div>
                </div>
                <span className="font-display text-[11px] uppercase tracking-[0.6em] text-white/20 group-hover:text-gold transition-all duration-700 group-hover:tracking-[0.8em] font-medium">{social.label}</span>
              </motion.a>
            ))}
          </motion.div>
        </div>
      ...
      {/* Footer */}
      <footer className="border-t border-gold/20 bg-black pt-48 pb-20 px-10 relative overflow-hidden">
          ...
          <div className="flex flex-col items-center justify-between gap-24 md:flex-row">
            <div className="text-center md:text-left group cursor-default">
              <motion.p 
                ...
                className="font-serif text-5xl italic text-gold-light mb-6 transition-all duration-1000 uppercase tracking-[0.4em]"
              >
                Broadway
              </motion.p>
              <div className="flex items-center justify-center md:justify-start gap-6">
                <div className="h-[1px] w-8 bg-gold/40"></div>
                <p className="text-[11px] text-white/30 tracking-[0.5em] font-display uppercase font-medium">Restauracja & Lounge</p>
              </div>
            </div>
            
            <div className="flex flex-col items-center md:items-end gap-10">
              <p className="text-[10px] text-white/20 font-display uppercase tracking-[0.4em] font-medium">
                © {new Date().getFullYear()} Broadway. Spektakl smaku.
              </p>
              <div className="h-[2px] w-48 bg-gradient-to-l from-gold/40 via-velvet/40 to-transparent"></div>
            </div>
          </div>
        </div>
      </footer>
